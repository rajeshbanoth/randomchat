...
export const getEstimatedResponse = (priority) => {
  const responseTimes = {
    'low': '48 hours',
    'normal': '24 hours',
    'high': '12 hours',
...
export const generateUserEmailHTML = (data, ticketNumber, estimatedResponse) => {
...
export const generateSupportEmailHTML = (data, ticketNumber) => {
  return `
  <!DOCTYPE html>
  <html>
  <head>
